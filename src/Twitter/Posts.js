...
function Posts(props) {
    const {avatarsrc,imgsrc, videosrc, displayName, userName, message} = props;
    return (
        <div className="post">
            ...
            <div className="post_body">
                <div className="post_header">
                    <div className = "post_header_text">
                        <h3>{displayName}
                        <span className="post_header_user">
                            &nbsp;@{userName}
                        </span>
                        </h3>
                    </div>
